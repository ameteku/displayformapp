...
namespace DisplayFormApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "COB Computer Lab Daily Schedule";
            ...
            this.label5.Location = new System.Drawing.Point(799, 65);
            ...
            this.label6.Location = new System.Drawing.Point(858, 93);
        ...
        public void modifyGridView1()
        {
            ...
            if (columns.Count > 0)
            {
                foreach(DataGridViewColumn column in columns)
                {
                    ...
                    else if( headerText == DataGridView1Headers.StartTime.ToString() || headerText == DataGridView1Headers.EndTime.ToString())
                    {
